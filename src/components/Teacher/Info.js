...
class Info extends Component {
  constructor(props) {
    ...
    this.state = {
      texts: {
        profils:
                    'Dans cette partie du Dashboard, <br/>vous pouvez clicker sur chacun <br/>des elements afin que la liste des <br/>étudiants proposés soit filtrée pour <br/>ce profil.',
        repartition:
